    ...
    <div class="row justify-content-center mx-0">
        <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
            <div class="card card-body shadow-blur mx-3 mx-md-4 rounded-0">
                ...
                <?php endif; ?>
                <div class="container">
                    <h4 class="fw-bolder text-center">Connexion Vendeur</h4>
                    <hr>
                    <br>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-sm-6">
                            <a href="<?= base_url ?>" class="text-primary">Voir le site</a>
                        </div>
                        <div class="col-sm-6 text-end">
                            <button class="btn btn-primary bg-gradient rounded-0 mb-0">Connexion</button>
                        </div>
                        
                        <div class="col-sm-12 text-center">
                            <a href="<?= base_url ?>seller/registration.php" class="text-primary">S'inscrire</a>
                        </div>
