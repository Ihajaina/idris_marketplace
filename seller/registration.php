    ...
    <div class="row justify-content-center mx-0">
        <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
            <div class="card card-body shadow-blur mx-3 mx-md-4 rounded-0">
                ...
                <?php endif; ?>
                <div class="container">
                    <h4 class="fw-bolder text-center">Inscription Vendeur</h4>
                    <hr>
                    <br>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="firstname" class="form-label">Prénom <span class="text-primary">*</span></label>
                                ...
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="middlename" class="form-label">Deuxième prénom</label>
                                    <input type="text" name="middlename" id="middlename" class="form-control form-control-lg" value="<?= isset($middlename) ?  $middlename : '' ?>">
                                </div>
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="lastname" class="form-label">Nom de famille <span class="text-primary">*</span></label>
                                ...
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="contact" class="form-label">Numéro de contact <span class="text-primary">*</span></label>
                                ...
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="website" class="form-label">Site web <small><span class="text-muted fst-italic">optionnel</span></small></label>
                                    <input type="text" name="website" id="website" class="form-control form-control-lg" value="<?= isset($website) ?  $website : '' ?>" placeholder="optionnel">
                                </div>
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="fb_link" class="form-label">Lien de la page Facebook <small><span class="text-muted fst-italic">optionnel</span></small></label>
                                    <input type="text" name="fb_link" id="fb_link" class="form-control form-control-lg" value="<?= isset($fb_link) ?  $fb_link : '' ?>" placeholder="optionnel">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-sm-6 text-end">
                            <button class="btn btn-primary bg-gradient rounded-0 mb-0">Mettre à jour le compte</button>
                        </div>
                        <div class="col-sm-12 text-center mt-3">
                            <a href="javascript:history.back()" class="text-primary">Retour</a>
                        </div>
                    </div>
